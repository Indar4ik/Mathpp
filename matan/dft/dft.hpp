...
// вокруг нуля, а заодно расстраивает соответствие бин<->гармоника), здесь линейно
// интерполируется та же кривая в N = bit_ceil точек, равномерно по параметру. Кривая та же,
